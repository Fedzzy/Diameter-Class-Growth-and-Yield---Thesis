...
#Calculating RMSE
RMSE(SzPt25ParamDat, SzPt25ParamDat$AMDat, SzPt25ParamDat$Pred_AMD, 5)
...
QMD_Mod2<-nls(QMDat~exp(b1+b2*RS+b3*LTPH+b4*LHt+(b5/Age)),
              ...
              start=list(b1=4.3, b2=-0.2, b3=-0.3, b4=0.2, b5=-.5))
...
#Calculating RMSE
RMSE(SzPt25ParamDat, SzPt25ParamDat$QMDat, SzPt25ParamDat$Pred_QMD, 5)
...
#Calculating RMSE
RMSE(SzPt25ParamDat, SzPt25ParamDat$D0, SzPt25ParamDat$Pred_D0, 5)
...
#Calculating RMSE
RMSE(SzPt25ParamDat, SzPt25ParamDat$D93, SzPt25ParamDat$Pred_D93, 5)
...
#Calculating RMSE
RMSE(SzPt25ParamDat, SzPt25ParamDat$D95, SzPt25ParamDat$Pred_D95, 5)