#Error index calculations for model 1

#loading in necessary files
load(file="GreenWt & DollVal_Model 1.Rdata")
...
ErrorIndex_05_M1<-ddply(FinalTable_05, .(MeasmtObs), summarize,
...
ErrorIndex_10_M1<-ddply(FinalTable_10, .(MeasmtObs), summarize,
...
ErrorIndex_15_M1<-ddply(FinalTable_15, .(MeasmtObs), summarize,
...
ErrorIndex_20_M1<-ddply(FinalTable_20, .(MeasmtObs), summarize,
...
ErrorIndex_25_M1<-ddply(FinalTable_25, .(MeasmtObs), summarize,
...
CombinedErrors_M1<-rbind(ErrorIndex_05_M1, ErrorIndex_10_M1, ErrorIndex_15_M1, ErrorIndex_20_M1, ErrorIndex_25_M1)

#Savings datasets into collective .Rdata file
save(ErrorIndex_05_M1, ErrorIndex_10_M1, ErrorIndex_15_M1, ErrorIndex_20_M1,
     
     ErrorIndex_25_M1, CombinedErrors_M1, file="ErrorIndex_M1.Rdata")
