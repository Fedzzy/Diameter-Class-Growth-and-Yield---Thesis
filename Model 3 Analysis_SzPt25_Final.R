...
#Calculating RMSE
RMSE(SzPt25ParamDat, SzPt25ParamDat$AMDat, SzPt25ParamDat$Pred_AMD, 3)
...
#Calculating RMSE
RMSE(SzPt25ParamDat, SzPt25ParamDat$QMDat, SzPt25ParamDat$Pred_QMD, 3)
...
#Generating summary of results
summary(D0_Mod3)  #RMSE 1.992

#Predicting Values
SzPt25ParamDat$Pred_D0<-predict(D0_Mod3)

#Calculating RMSE
RMSE(SzPt25ParamDat, SzPt25ParamDat$D0, SzPt25ParamDat$Pred_D0, 2)
...
#Calculating RMSE
RMSE(SzPt25ParamDat, SzPt25ParamDat$D50, SzPt25ParamDat$Pred_D50, 3)
...
#Calculating RMSE
RMSE(SzPt25ParamDat, SzPt25ParamDat$D95, SzPt25ParamDat$Pred_D95, 3)
...
#Get column subsets
M3_PlotSz25<-SzPt25ParamDat[,c("MeasmtObs","Age","DomHtM","TPH","RS",
                               "Pred_AMD", "Pred_QMD","Pred_D0","Pred_D25","Pred_D50","Pred_D93",
                               "Pred_D95")]



save(M3_PlotSz25,file="K:/csabatia/GraduateStudentWork/JoshBankston/Data Analysis/Distribution Recovery Analyses/Model 3_BF87/M3_PlotLevelAnalysis25.RData")
