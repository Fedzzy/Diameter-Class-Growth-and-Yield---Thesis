#Non-Linear Regression and Prediction for Model 2 - SzPt20
...
SzPt20ParamDat$LTPH<-log(SzPt20ParamDat$TPH)
SzPt20ParamDat$LHt<-log(SzPt20ParamDat$DomHtM)
...
#Predicting Values
SzPt20ParamDat$Pred_AMD<-predict(AMD_Mod2)
...
#Predicting Values
SzPt20ParamDat$Pred_QMD<-predict(QMD_Mod2)
...
#Generating summary of results
summary(D0_Mod2)  #RMSE 1.902

#Predicting Values
SzPt20ParamDat$Pred_D0<-predict(D0_Mod2)

#Calculating RMSE
RMSE(SzPt20ParamDat, SzPt20ParamDat$D0, SzPt20ParamDat$Pred_D0, 3)
...
#Predicting Values
SzPt20ParamDat$Pred_D25<-predict(D25_Mod2)

#Calculating RMSE
RMSE(SzPt20ParamDat, SzPt20ParamDat$D25, SzPt20ParamDat$Pred_D25, 5)
...
#Predicting Values
SzPt20ParamDat$Pred_D50<-predict(D50_Mod2)

#Calculating RMSE
RMSE(SzPt20ParamDat, SzPt20ParamDat$D50, SzPt20ParamDat$Pred_D50, 5)
...
#Predicting Values
SzPt20ParamDat$Pred_D93<-predict(D93_Mod2)
...
#Predicting Values
SzPt20ParamDat$Pred_D95<-predict(D95_Mod2)
...
#Get column subsets
M2_PlotSz20<-SzPt20ParamDat[,c("MeasmtObs","Age","DomHtM","TPH","RS",
                            "Pred_AMD", "Pred_QMD","Pred_D0","Pred_D25","Pred_D50","Pred_D93",
                            "Pred_D95")]



save(M2_PlotSz20,file="K:/csabatia/GraduateStudentWork/JoshBankston/Data Analysis/Distribution Recovery Analyses/Model 2_MF1992/M2_PlotLevelAnalysis20.RData")
