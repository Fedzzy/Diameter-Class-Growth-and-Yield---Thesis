...
#Calculating RMSE
RMSE(SzPt20ParamDat, SzPt20ParamDat$AMDat, SzPt20ParamDat$Pred_AMD, 3)
...
#Calculating RMSE
RMSE(SzPt20ParamDat, SzPt20ParamDat$QMDat, SzPt20ParamDat$Pred_QMD, 3)
...
#Generating summary of results
summary(D0_Mod3)  #RMSE 2.011

#Predicting Values
SzPt20ParamDat$Pred_D0<-predict(D0_Mod3)

#Calculating RMSE
RMSE(SzPt20ParamDat, SzPt20ParamDat$D0, SzPt20ParamDat$Pred_D0, 2)
...
#Calculating RMSE
RMSE(SzPt20ParamDat, SzPt20ParamDat$D50, SzPt20ParamDat$Pred_D50, 3)
...
#Calculating RMSE
RMSE(SzPt20ParamDat, SzPt20ParamDat$D93, SzPt20ParamDat$Pred_D93, 3)
...
#Calculating RMSE
RMSE(SzPt20ParamDat, SzPt20ParamDat$D95, SzPt20ParamDat$Pred_D95, 3)
...
#Get column subsets
M3_PlotSz20<-SzPt20ParamDat[,c("MeasmtObs","Age","DomHtM","TPH","RS",
                               "Pred_AMD", "Pred_QMD","Pred_D0","Pred_D25","Pred_D50","Pred_D93",
                               "Pred_D95")]



save(M3_PlotSz20,file="K:/csabatia/GraduateStudentWork/JoshBankston/Data Analysis/Distribution Recovery Analyses/Model 3_BF87/M3_PlotLevelAnalysis20.RData")
