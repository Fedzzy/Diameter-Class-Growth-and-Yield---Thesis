...
#Load the data
load("Model 2 Predicted Weibull Parameter Data.Rdata")
...
Plots<-as.list(levels(PWM2_05$MeasmtObs))
...
for(k in 1:length(Plots))
{
  ...
  cH=PWM2_05[k,"PWH_C"]
  #Inialization
  treesTotal=PWM2_05[k,"NumTrees"]/PWM2_05[k,"PS"]
  treesRemainM<-treesTotal
  treesRemainP<-treesTotal
  treesRemainH<-treesTotal
  minDbhClass<-getDbhClass((PWM2_05[k,"dbhMin"])*0.393701)
...
#Get a listing of all Plots
Plots<-as.list(levels(PWM2_10$MeasmtObs))
#Initialize Stand Table for All Plots
...
for(k in 1:length(Plots))
{
  ...
  cH=PWM2_10[k,"PWH_C"]
  #Inialization
  treesTotal=PWM2_10[k,"NumTrees"]/PWM2_10[k,"PS"]
  treesRemainM<-treesTotal
  treesRemainP<-treesTotal
  treesRemainH<-treesTotal
  minDbhClass<-getDbhClass((PWM2_10[k,"dbhMin"])*0.393701)
  i<-minDbhClass-0.5 #Start at the bottom of the minimum dbh class
  currentDbh<-minDbhClass
  counter=1
  dbhClasses<-NULL 
...
#Get a listing of all Plots
Plots<-as.list(levels(PWM2_15$MeasmtObs))
#Initialize Stand Table for All Plots
...
for(k in 1:length(Plots))
{
  ...
  cH=PWM2_15[k,"PWH_C"]
  #Inialization
  treesTotal=PWM2_15[k,"NumTrees"]/PWM2_15[k,"PS"]
  treesRemainM<-treesTotal
  treesRemainP<-treesTotal
  treesRemainH<-treesTotal
  minDbhClass<-getDbhClass((PWM2_15[k,"dbhMin"])*0.393701)
  i<-minDbhClass-0.5 #Start at the bottom of the minimum dbh class
  currentDbh<-minDbhClass
  counter=1
  dbhClasses<-NULL 
...
#Get a listing of all Plots
Plots<-as.list(levels(PWM2_20$MeasmtObs))
#Initialize Stand Table for All Plots
...
for(k in 1:length(Plots))
{
  ...
  cH=PWM2_20[k,"PWH_C"]
  #Inialization
  treesTotal=PWM2_20[k,"NumTrees"]/PWM2_20[k,"PS"]
  treesRemainM<-treesTotal
  treesRemainP<-treesTotal
  treesRemainH<-treesTotal
  minDbhClass<-getDbhClass((PWM2_20[k,"dbhMin"])*0.393701)
  i<-minDbhClass-0.5 #Start at the bottom of the minimum dbh class
  currentDbh<-minDbhClass
  counter=1
  dbhClasses<-NULL 
...
#Get a listing of all Plots
Plots<-as.list(levels(PWM2_25$MeasmtObs))
#Initialize Stand Table for All Plots
...
for(k in 1:length(Plots))
{
  ...
  cH=PWM2_25[k,"PWH_C"]
  #Inialization
  treesTotal=PWM2_25[k,"NumTrees"]/PWM2_25[k,"PS"]
  treesRemainM<-treesTotal
  treesRemainP<-treesTotal
  treesRemainH<-treesTotal
  minDbhClass<-getDbhClass((PWM2_25[k,"dbhMin"])*0.393701)
  i<-minDbhClass-0.5 #Start at the bottom of the minimum dbh class
  currentDbh<-minDbhClass
  counter=1
  dbhClasses<-NULL 
