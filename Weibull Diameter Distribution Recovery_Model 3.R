...
#Load the data
load("Model 3 Predicted Weibull Parameter Data.Rdata")
...
Plots<-as.list(levels(PWM3_05$MeasmtObs))
...
for(k in 1:length(Plots))
{
  ...
  cH=PWM3_05[k,"PWH_C"]
  #Inialization
  treesTotal=PWM3_05[k,"NumTrees"]/PWM3_05[k,"PS"]
  treesRemainM<-treesTotal
  treesRemainP<-treesTotal
  treesRemainH<-treesTotal
  minDbhClass<-getDbhClass((PWM3_05[k,"dbhMin"])*0.393701)
...
#Get a listing of all Plots
Plots<-as.list(levels(PWM3_10$MeasmtObs))
#Initialize Stand Table for All Plots
...
for(k in 1:length(Plots))
{
  ...
  cH=PWM3_10[k,"PWH_C"]
  #Inialization
  treesTotal=PWM3_10[k,"NumTrees"]/PWM3_10[k,"PS"]
  treesRemainM<-treesTotal
  treesRemainP<-treesTotal
  treesRemainH<-treesTotal
  minDbhClass<-getDbhClass((PWM3_10[k,"dbhMin"])*0.393701)
  i<-minDbhClass-0.5 #Start at the bottom of the minimum dbh class
  currentDbh<-minDbhClass
  counter=1
  dbhClasses<-NULL 
...
#Get a listing of all Plots
Plots<-as.list(levels(PWM3_15$MeasmtObs))
#Initialize Stand Table for All Plots
...
for(k in 1:length(Plots))
{
  ...
  cH=PWM3_15[k,"PWH_C"]
  #Inialization
  treesTotal=PWM3_15[k,"NumTrees"]/PWM3_15[k,"PS"]
  treesRemainM<-treesTotal
  treesRemainP<-treesTotal
  treesRemainH<-treesTotal
  minDbhClass<-getDbhClass((PWM3_15[k,"dbhMin"])*0.393701)
  i<-minDbhClass-0.5 #Start at the bottom of the minimum dbh class
  currentDbh<-minDbhClass
  counter=1
  dbhClasses<-NULL 
...
#Get a listing of all Plots
Plots<-as.list(levels(PWM3_20$MeasmtObs))
#Initialize Stand Table for All Plots
...
for(k in 1:length(Plots))
{
  ...
  cH=PWM3_20[k,"PWH_C"]
  #Inialization
  treesTotal=PWM3_20[k,"NumTrees"]/PWM3_20[k,"PS"]
  treesRemainM<-treesTotal
  treesRemainP<-treesTotal
  treesRemainH<-treesTotal
  minDbhClass<-getDbhClass((PWM3_20[k,"dbhMin"])*0.393701)
  i<-minDbhClass-0.5 #Start at the bottom of the minimum dbh class
  currentDbh<-minDbhClass
  counter=1
  dbhClasses<-NULL 
...
#Get a listing of all Plots
Plots<-as.list(levels(PWM3_25$MeasmtObs))
#Initialize Stand Table for All Plots
...
for(k in 1:length(Plots))
{
  ...
  cH=PWM3_25[k,"PWH_C"]
  #Inialization
  treesTotal=PWM3_25[k,"NumTrees"]/PWM3_25[k,"PS"]
  treesRemainM<-treesTotal
  treesRemainP<-treesTotal
  treesRemainH<-treesTotal
  minDbhClass<-getDbhClass((PWM3_25[k,"dbhMin"])*0.393701)
  i<-minDbhClass-0.5 #Start at the bottom of the minimum dbh class
  currentDbh<-minDbhClass
  counter=1
  dbhClasses<-NULL 
...
save(standTableAllPlots_05, standTableAllPlots_10, standTableAllPlots_15, standTableAllPlots_20, standTableAllPlots_25,
     ...
     file="PredictedDbhDistbn_Mod3.RData")
