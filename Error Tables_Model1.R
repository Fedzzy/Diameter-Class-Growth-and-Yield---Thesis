...
load(file="Error Tables_Model 1.RData")
...
#Dropping dbhClass column
FinalTable_05$dbhClass<-NULL
...
#Dropping dbh column
FinalTable_20$dbhClass<-NULL

#==================================Creation of QMD column and Merging Data sets for .25 Acre=====================
...
#Dropping dbh column
FinalTable_25$dbhClass<-NULL

#==============Saving Final Tables to an .RData file================
save(FinalTable_05, FinalTable_10, FinalTable_15, FinalTable_20, FinalTable_25, file="Final Error Tables_Model 1.RData")
