...
#Calculating RMSE
RMSE(SzPt10ParamDat, SzPt10ParamDat$AMDat, SzPt10ParamDat$Pred_AMD, 4)
...
#Calculating RMSE
RMSE(SzPt10ParamDat, SzPt10ParamDat$QMDat, SzPt10ParamDat$Pred_QMD, 4)
...
#Generating summary of results
summary(D0_Mod2)  #RMSE 1.981

#Predicting Values
SzPt10ParamDat$Pred_D0<-predict(D0_Mod2)

#Calculating RMSE
RMSE(SzPt10ParamDat, SzPt10ParamDat$D0, SzPt10ParamDat$Pred_D0, 4)
...
#Get column subsets
M2_PlotSz10<-SzPt10ParamDat[,c("MeasmtObs","Age","DomHtM","TPH","RS",
                            "Pred_AMD", "Pred_QMD","Pred_D0","Pred_D25","Pred_D50","Pred_D93",
                            "Pred_D95")]



save(M2_PlotSz10,file="K:/csabatia/GraduateStudentWork/JoshBankston/Data Analysis/Distribution Recovery Analyses/Model 2_MF1992/M2_PlotLevelAnalysis10.RData")
