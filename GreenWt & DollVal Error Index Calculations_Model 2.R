#Error index calculations for model 2

#loading in necessary files
load(file="GreenWt & DollVal_Model 2.Rdata")
...
ErrorIndex_05_M2<-ddply(FinalTable_05, .(MeasmtObs), summarize,
...
ErrorIndex_10_M2<-ddply(FinalTable_10, .(MeasmtObs), summarize,
...
ErrorIndex_15_M2<-ddply(FinalTable_15, .(MeasmtObs), summarize,
...
ErrorIndex_20_M2<-ddply(FinalTable_20, .(MeasmtObs), summarize,
...
ErrorIndex_25_M2<-ddply(FinalTable_25, .(MeasmtObs), summarize,
...
CombinedErrors_M2<-rbind(ErrorIndex_05_M2, ErrorIndex_10_M2, ErrorIndex_15_M2, ErrorIndex_20_M2, ErrorIndex_25_M2)

#Savings datasets into collective .Rdata file
save(ErrorIndex_05_M2, ErrorIndex_10_M2, ErrorIndex_15_M2, ErrorIndex_20_M2,
     
     ErrorIndex_25_M2, CombinedErrors_M2, file="ErrorIndex_M2.Rdata")
